...
var G__6260 = o;
(G__6260[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__6262__i = 0, G__6262__a = new Array(arguments.length -  0);
while (G__6262__i < G__6262__a.length) {G__6262__a[G__6262__i] = arguments[G__6262__i + 0]; ++G__6262__i;}
  args = new cljs.core.IndexedSeq(G__6262__a,0);
} 
...
if(cljs.core.truth_((function (){var and__4659__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__4659__auto__){
var and__4659__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
...
var G__6268 = jsprops;
(G__6268["defaultValue"] = value);

(G__6268["onChange"] = ((function (G__6268,v,value,on_change){
return (function (p1__6266_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__6266_SHARP_);
});})(G__6268,v,value,on_change))
);
...
var vec__6273 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__6273,(0),null);
var id = cljs.core.nth.call(null,vec__6273,(1),null);
var class$ = cljs.core.nth.call(null,vec__6273,(2),null);
...
var jsprops = {"argv": v};
var temp__4429__auto___6276 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4429__auto___6276 == null)){
} else {
var key_6277 = temp__4429__auto___6276;
(jsprops["key"] = key_6277);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__6279 = (new reagent.impl.template.NativeWrapper());
(G__6279["name"] = c);
...
args__5736__auto__.push((arguments[i__5730__auto___6286]));
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq6283){
var G__6284 = cljs.core.first.call(null,seq6283);
var seq6283__$1 = cljs.core.next.call(null,seq6283);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__6284,seq6283__$1);
});
...
break;
default:
var G__6291 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__6291;
continue;
...
var n__5574__auto___6292 = a.length;
var i_6293 = (0);
while(true){
if((i_6293 < n__5574__auto___6292)){
(a[i_6293] = reagent.impl.template.as_element.call(null,(a[i_6293])));
...
var a = cljs.core.into_array.call(null,s);
var n__5574__auto___6295 = a.length;
var i_6296 = (0);
while(true){
if((i_6296 < n__5574__auto___6295)){
var val_6297 = (a[i_6296]);
if((cljs.core.vector_QMARK_.call(null,val_6297)) && ((reagent.impl.template.key_from_vec.call(null,val_6297) == null))){
(o["no-key"] = true);
} else {
}

(a[i_6296] = reagent.impl.template.as_element.call(null,val_6297));
...
var ctx = {};
var vec__6300 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__6300,(0),null);
var derefed = cljs.core.nth.call(null,vec__6300,(1),null);
...
var G__6302 = (cljs.core.count.call(null,argv) - first_child);
switch (G__6302) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__6302){
